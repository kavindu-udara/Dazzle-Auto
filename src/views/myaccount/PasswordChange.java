...
public class PasswordChange extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(title, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 61, 498, 28));
        ...
        if (password.isEmpty()) {
            ...
            if (password.equals(password2)) {
                try {
                    ...
                    JOptionPane.showMessageDialog(this, "Password Changed.", "Error", JOptionPane.INFORMATION_MESSAGE);
