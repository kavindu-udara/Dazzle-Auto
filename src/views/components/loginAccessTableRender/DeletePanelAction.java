 ...
 * @author E
 */
public class DeletePanelAction extends javax.swing.JPanel {

    /**
     * Creates new form PanelAction
     */
    public DeletePanelAction() {
        initComponents();
    }

    public void initEvent(DeleteActionEvent event, int row) {
    ...
    private void initComponents() {
        ...
        cmdDelete.setBackground(new java.awt.Color(255, 218, 218));
        cmdDelete.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        cmdDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icons/delete.png"))); // NOI18N
