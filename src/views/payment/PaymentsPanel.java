...
public class PaymentsPanel extends javax.swing.JPanel {
    ...
    public PaymentsPanel() {
        ...
        jTextField2.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Enter INVOICE ID");
        
        PendingInvoiceTableRender();
        PaidInvoiceTableRender();
    }

    public void PendingInvoiceTableRender() {

        DefaultTableCellRenderer centerRenderer = new DefaultTableCellRenderer();
        centerRenderer.setHorizontalAlignment(JLabel.CENTER);

        JTableHeader tableHeader = jPendingInvoiceTable.getTableHeader();
        ...
        for (int i = 0; i < 4; i++) {
            jPendingInvoiceTable.getColumnModel().getColumn(i).setCellRenderer(centerRenderer);
        }
    }
    ...
    private void initComponents() {
        ...
        jPendingInvoiceTable = new javax.swing.JTable();
        ...
        setMinimumSize(new java.awt.Dimension(1092, 610));
        ...
        jPendingInvoiceTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "INVOICE ID", "Date", "Amount", "Issued By"
            }
        ) {
        ...
        jPendingInvoiceTable.setRowHeight(30);
        jPendingInvoiceTable.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(jPendingInvoiceTable);
        ...
        jLabel2.setText("Pending Invoices");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(invoiceAddButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(invoiceAddButton, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private javax.swing.JTable jPendingInvoiceTable;
