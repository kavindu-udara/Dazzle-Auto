...
public class RegexValidator {
     ...
     * - The URL must contain letters, numbers, +, &, @, #, /, % , ?, =, ~, _,
     * !, :, ;, or . <br>
     ...
     * <p>
     * The regex pattern is as follows: <br>
     * - The ISBN must start with "ISBN" (case insensitive) followed by a hyphen
     * and the number 1, 0, or 3, or just the number 1, 0, or 3 <br>
     ...
     * - The day must be represented by two digits, the first being 0, 1, 2, or
     * 3 <br>
