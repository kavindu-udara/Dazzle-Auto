...
public class EmployeeController {
    ...
    public ResultSet showByEmailOrMobileOrNIC(String email, String mobile, String nic) throws Exception {
        return MySqlConnection.executeSearch("SELECT * FROM `" + tableName + "` WHERE `email`='" + email + "' OR `nic`='" + nic + "' OR `mobile`='"+mobile+"' ");
    }
